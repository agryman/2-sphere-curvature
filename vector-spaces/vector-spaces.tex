...
\where
	\forall n: \nat @ \\
	\t1	\tauRn(n) = topGen[\Rtuples(n)] \{~ v: \Rtuples(n); r: \R @ \ballRn(n,v,r) ~\}
\end{axdef}
...
Let $\smoothRnn(x,n,m)$ denote the set of all functions $f \in \Rtuples(n) \pfun \Rtuples(m)$ that are smooth at $x \in \Rtuples(n)$.
